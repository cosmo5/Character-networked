...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	[GeneratedRPCVariableNames("{\"types\":[[\"Pos\", \"Rot\"][\"SpawnPos\"]]")]
	public abstract partial class PlayerControllerBehavior : NetworkBehavior
	{
		public const byte RPC_UPDATE_POS = 0 + 5;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject.RegisterRpc("UpdatePos", UpdatePos, typeof(Vector3), typeof(Quaternion));
		...
		/// Quaternion Rot
		/// </summary>
		public abstract void UpdatePos(RpcArgs args);
		/// <summary>
		/// Arguments:
		/// Vector3 SpawnPos
		/// </summary>
