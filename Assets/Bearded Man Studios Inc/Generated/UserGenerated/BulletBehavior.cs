...
{
	[GeneratedRPC("{\"types\":[[\"uint\"][\"Vector3\", \"Quaternion\"]]")]
	[GeneratedRPCVariableNames("{\"types\":[[\"PlayerID\"][\"Pos\", \"Rot\"]]")]
	public abstract partial class BulletBehavior : NetworkBehavior
	{
		public const byte RPC_HIT_PLAYER = 0 + 5;
		public const byte RPC_INIT = 1 + 5;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject.RegisterRpc("HitPlayer", HitPlayer, typeof(uint));
			networkObject.RegisterRpc("Init", Init, typeof(Vector3), typeof(Quaternion));
		...
		/// uint PlayerID
		/// </summary>
		public abstract void HitPlayer(RpcArgs args);
		/// <summary>
		/// Arguments:
		/// Vector3 Pos
		/// Quaternion Rot
